  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-start pt-10 px-4 sm:px-6 md:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 opacity-30 pointer-events-none">
        ...
        <div className="absolute top-40 right-10 w-48 md:w-72 h-48 md:h-72 bg-emerald-300 rounded-full mix-blend-multiply filter blur-xl animate-blob animation-delay-2000"></div>
      ...
      >
        ...
        {/* Text under carousel */}
        {images[active] && (
          <div className="mt-10 max-w-2xl text-center space-y-4 bg-transparent border-2 border-emerald-400 shadow-2xl px-10 py-3 rounded-3xl mb-3">
